            ...
            <Container style={{height:'80vh', marginTop:'2em'}}>
                <Segment>
                    <Form widths={'equal'} onSubmit={blogCreateHandler} >
                        <Form.Input fluid label='Title' placeholder='Title of the blog..' onChange={(event)=> setTitleText(event.target.value)}/>
                        <Form.TextArea label='About' placeholder='Tell us more...' rows={10} onChange={(event)=> setAboutText(event.target.value)}/>
